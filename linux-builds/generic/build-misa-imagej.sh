...
JDK_DOWNLOAD="https://github.com/AdoptOpenJDK/openjdk8-binaries/releases/download/jdk8u232-b09/OpenJDK8U-jdk_x64_linux_hotspot_8u232b09.tar.gz"
...
download_targz_if_not_exist $JDK_DOWNLOAD $JDK_NAME
download_zip_if_not_exist $MAVEN_DOWNLOAD $MAVEN_NAME

PATH=$PWD/$MAVEN_NAME/bin/:$PWD/$JDK_NAME/bin/:$PATH

# Build MISA++ for ImageJ
download_zip_if_not_exist $MISA_IMAGEJ_SOURCES "misa-imagej-master"
